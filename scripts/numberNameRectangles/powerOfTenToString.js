(function($)
{
	$(document).ready(function()
	{
		...
		if (notLoaded)
		{
			$('.power-of-ten-result').html('<span style="color:red;font-weight:bold;">Error: Number-Name could not be loaded</span>');
		}
		...
		power_of_ten_button_onclick = notLoaded ? function(){} : function()
		{
			...
			else
			{
				try
				{
					result = '<span style="word-wrap:break-word;">' + io.harriknox.NumberName.power_of_10_to_string(value) + '</span>';
				}
				catch (e)
				{
